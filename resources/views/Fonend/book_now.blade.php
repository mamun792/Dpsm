                    ...
                    <div class="card-body">
                        <div class="booking-doc-info">
                            <a href="doctor-profile.html" class="booking-doc-img">
                                <img src="{{asset('uploads/doctor_themble_photo')}}/{{$doctor->doctor_themble_photo}}" alt="User Image">
                            </a>
                            <div class="booking-info">
                                <h4><a href="{{route('doctor.profile',$doctor->id)}}">{{$doctor->fname}} {{$doctor->lname}}</a></h4>
                                <div class="rating">
                                ...
                                <p class="text-muted mb-0"><i class="fas fa-map-marker-alt"></i> {{$doctor->city}}, {{$doctor->locations}}</p>
                            </div>
                        </div>
                    </div>
                </div>
