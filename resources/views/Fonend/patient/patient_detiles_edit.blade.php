        ...
        <div class="row form-row">
            <div class="col-12 col-md-12">
                <div class="form-group">
                    <h1 class="text-center ">Basic Information Update</h1>
                </div>
            ...
            <div class="col-12 col-sm-6">
                <div class="form-group">
                    <label>Mobile</label>
                    <input type="text" name="phone_number" value="{{$update->phone_number}}" placeholder="Phone Number"
            ...
            <div class="col-12 col-sm-6">
                <div class="form-group">
                  ...
                  @enderror"" value=" {{$update->city}}" placeholder="City Name" name="city"> @error('city')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    <label>Address</label>
                    <input type="text" class="form-control" name="adderss" value="{{$update->adderss}}">
                    @error('adderss')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
