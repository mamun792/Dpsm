    ...
    <form method="POST" action="{{route('change.password')}}" >
        @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" name="password_confirmation" placeholder="old password">
        ...
        <h1 class="m-t-3">Change Information</h1>
                ...
                @csrf
                   ...
                   <div class="mb-4">
                    ...
                    <img class="rounded-circle" src="{{asset('uploads/profile_photo/')}}/{{auth()->user()->profile_photo}}" width="50" alt="user">
                    @else
