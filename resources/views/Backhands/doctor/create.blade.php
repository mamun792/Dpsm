        ...
        <div class="row form-row">
            <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('city') is-invalid @enderror" name="city" rows="2">{{old('city')}}</textarea>
                    @error('city')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('degree') is-invalid @enderror" name="degree" rows="3">{{old('degree')}}</textarea>
                    @error('degree')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('fillings') is-invalid @enderror " value="{{old('fillings')}}" name="fillings">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('locations') is-invalid @enderror" name="locations" rows="2">{{old('locations')}}</textarea>
                    @error('locations')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('overview') is-invalid @enderror" name="overview" rows="3">{{old('overview')}}</textarea>
                    @error('overview')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" multiple name="doctors_features_photos[]" onchange="readURL(this)";>
                    <img class="hidden mt-3" id="category_photo_viewer" src="#" alt="your image" />
                    <script>
                        function readURL(input) {
                            if (input.files && input.files[0]) {
                ...
                <div class="row form-row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" name="fillinges" value="{{old('fillinges')}}">
                            @error('fillinges')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="row form-row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="locations" value="{{old('locations')}}">
                            @error('locations')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
